...
const CATS: Cat[] = [
    ...
    items: [
      {
        ...
        a: (
          <>
            몰 관리 <b>🎉 이벤트 팝업·띠배너</b>에서 세일·공지를 손님에게 띄울 수 있어요. (무료 요금제도 가능!)
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>📢 <b>상단 띠배너</b> — 대문 맨 위 얇은 줄. 문구·링크·색상을 정해요.</div>
              <div>🪟 <b>진입 팝업</b> — 접속 시 가운데 뜨는 알림창. 제목·내용·이미지·버튼을 넣어요.</div>
              <div>각각 <b>켜고 끌 수</b> 있고, 손님은 팝업에서 <b>“오늘 그만보기”</b>를 누를 수 있어요.</div>
            </div>
          </>
        ),
      },
      {
        q: "🔎 검색 노출(SEO) — 구글·네이버에 잘 뜨게",
        a: (
          <>
            몰 관리 <b>🔎 검색 노출(SEO)</b>에서 <b>검색 제목·설명·키워드</b>를 정하면 구글·네이버 검색과
            카톡 공유 미리보기에 그대로 나와요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>🗺️ 발행한 쇼핑몰은 <b>사이트맵에 자동 등록</b>돼 검색엔진이 수집해요.</div>
              <div>🔧 더 빠른 노출은 구글 서치콘솔·네이버 서치어드바이저에 <b>on.온종일.com/sitemap.xml</b> 등록.</div>
              <div>비우면 쇼핑몰 이름·소개로 자동. (베이직 요금제부터)</div>
            </div>
          </>
        ),
      },
    ...
    items: [
      {
        ...
        a: (
          <>
            상품이 많으면 하나씩 올리지 말고 <b>상품 → “📋 대량 등록”</b>을 쓰세요.
            엑셀·구글시트에서 표를 복사해 붙여넣으면 <b>한 번에 등록</b>돼요.
            <div className="mt-1.5 text-[12.5px] text-neutral-500 dark:text-neutral-400">
              순서: <b>상품명, 가격, 카테고리, 설명, 재고, 이모지</b> · 상품명·가격만 있어도 OK · “예시 채우기”로 형식 확인.
            </div>
          </>
        ),
      },
      {
        q: "📦 옵션 조합별 재고 (색상×사이즈 등)",
        a: (
          <>
            상품 옵션(색상·사이즈 등)을 정하면 <b>조합이 자동으로 만들어져요</b>(빨강·S / 빨강·M …).
            <b>“📦 옵션 조합별 재고 관리”</b>를 켜고 조합마다 재고를 넣으면, 손님 화면에서
            <b> 품절된 조합은 못 고르고</b> 재고가 적으면 “○개 남음”이 떠요.
            <div className="mt-1.5 text-[12.5px] text-neutral-500 dark:text-neutral-400">
              ※ 옵션 1개면 선택지별 재고, 여러 개면 조합별로 자동 적응. 안 켜면 상품 단위 재고를 써요. (의류·축산·식품 모두 OK)
            </div>
          </>
        ),
      },
    ...
    items: [
      {
        ...
        a: (
          <>
            ...
            <div className="mt-1.5 text-[12.5px] text-neutral-500 dark:text-neutral-400">
              📥 주문 페이지 우측 <b>‘엑셀(CSV) 내보내기’</b>로 전체 주문을 한 번에 내려받아 정산·택배에 쓸 수 있어요.
            </div>
          </>
        ),
      },
      ...
      },
      {
        ...
        a: (
          <>
            <b>대시보드 → 🧾 주문</b>에서 각 주문의 <b>🚚 송장</b> 칸에 <b>택배사</b>를 고르고 <b>운송장번호</b>를 넣고 저장하세요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>그러면 <b>“🔍 배송조회”</b> 버튼이 자동으로 생겨요. (CJ·우체국·한진·롯데·로젠 전용 조회)</div>
              <div>손님도 <b>마이페이지 → 주문 내역</b>에서 “🚚 배송조회”로 바로 택배를 추적해요.</div>
              <div>따로 설정할 게 없어요. 송장만 넣으면 끝! (무료 요금제도 가능)</div>
            </div>
          </>
        ),
      },
  ...
  },
  {
    ...
    items: [
      {
        q: "🤖 쇼핑몰 챗봇 만들기 (손님 질문 자동 응대)",
        a: (
          <>
            몰 관리 <b>💬 쇼핑몰 챗봇</b>에서 자주 묻는 <b>질문/답을 직접 등록</b>하면, 손님 쇼핑몰
            오른쪽 아래에 <b>챗봇</b>이 떠서 손님이 눌러 바로 답을 봐요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>🎭 챗봇 <b>모양 9종</b>(디자이너·로봇·곰돌이·모던·톡톡팝·전문상담·고양이·병아리·판다)을 스킨에 맞게 골라요.</div>
              <div>🏷️ <b>챗봇 이름</b>과 <b>첫 인사말</b>도 직접 정할 수 있어요.</div>
              <div>✨ <b>“기본 질문 자동 채우기”</b>를 누르면 배송·교환·입금 등 자주 묻는 질문이 예시로 들어와요. (새 몰은 자동으로 채워져 나와요)</div>
            </div>
            <div className="mt-1.5 text-[12.5px] text-neutral-500 dark:text-neutral-400">
              ※ 질문을 <b>1개 이상</b> 넣어야 손님 화면에 챗봇이 떠요.
            </div>
          </>
        ),
      },
      ...
      },
      {
        ...
        a: (
          <>
            손님이 남긴 별점 후기는 <b>대시보드 → ⭐ 리뷰</b>에서 <b>“답글 달기”</b>로 답할 수 있어요.
            답글은 손님 상품 화면의 후기 아래 <b>“판매자 답글”</b>로 보라색 박스로 붙어요.
            <div className="mt-1.5 text-[12.5px] text-neutral-500 dark:text-neutral-400">
      ...
      {
        q: "💎 회원 등급(VIP) — 단골에게 더 큰 혜택",
        a: (
          <>
            몰 관리 <b>💎 회원 등급</b>에서 <b>켜기</b> 후 등급을 만들면, 손님의 <b>누적 구매액</b>에 따라
            자동으로 등급이 올라가고 <b>등급별 할인</b>이 결제 때 자동 적용돼요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>✨ <b>“기본 등급 채우기”</b>를 누르면 일반·실버·골드·VIP 4단계가 예시로 들어와요. (이름·기준금액·할인% 자유 수정)</div>
              <div>🛍 손님이 <b>주문 완료(구매확정)</b>할 때마다 누적액이 쌓이고, 등급은 <b>마이페이지</b>에 표시돼요.</div>
              <div>🔌 안 쓰면 <b>꺼두면</b> 돼요. (모든 기능은 켜고 끌 수 있어요)</div>
            </div>
          </>
        ),
      },
      {
        ...
        a: (
          <>
            <b>🎟️ 쿠폰</b> 메뉴 아래 <b>“자동 쿠폰 발급”</b>에서, 만든 쿠폰을 골라두면
            손님이 <b>가입</b>하거나 <b>주문</b>할 때 쿠폰함에 자동으로 들어가요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>🎁 <b>가입축하</b> — 회원가입 즉시 발급.</div>
              <div>🔄 <b>재구매</b> — 주문하면 다음 구매용 쿠폰을 줘요. (같은 쿠폰은 1회만)</div>
              <div>먼저 쿠폰을 만들어야 고를 수 있어요. 안 고르면 자동발급 안 함.</div>
            </div>
          </>
        ),
      },
      {
        q: "🔔 재입고 알림 — 품절 상품 손님 모으기",
        a: (
          <>
            상품 재고가 <b>0이 되면</b> 손님 화면에 <b>품절</b>로 표시되고, 손님이 상품 상세에서
            <b> “🔔 재입고 알림”</b>으로 연락처를 남길 수 있어요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>신청자는 <b>대시보드 → 🔔 재입고</b> 메뉴에서 <b>상품별</b>로 모여요.</div>
              <div>재입고하면 상품별 <b>“입고 알림 보내기”</b> 한 번이면, 신청한 손님들 화면·팝업에 <b>“입고됐어요”</b>가 떠요.</div>
              <div>품절이어도 사고 싶은 손님을 놓치지 않아요. (베이직 요금제부터)</div>
            </div>
          </>
        ),
      },
      {
        q: "📍 배송지 주소록 — 손님이 여러 주소 저장",
        a: (
          <>
            손님은 <b>마이페이지 → 📍 배송지 주소록</b>에서 집·회사 등 <b>여러 배송지를 저장</b>해요.
            <div className="mt-1.5 space-y-1 text-[12.5px]">
              <div>주문할 때 저장한 주소를 <b>칩 한 번</b>으로 받는사람·연락처·주소가 자동 입력돼요.</div>
              <div>기본 배송지를 정해두면 더 빨라요. (창업자가 설정할 건 없어요, 손님 편의 기능)</div>
            </div>
          </>
        ),
      },
    ...
    items: [
      {
        ...
        a: (
          <>
            <b>대시보드</b>(요약) · <b>쇼핑몰</b>(생성/관리) · <b>상품</b> · <b>주문/고객</b> · <b>리뷰/문의</b> ·{" "}
            <b>분석</b>(통계) · <b>설정</b>(비밀번호 등)을 한 곳에서 관리해요.
          </>
        ),
      },
      {
    ...
    items: [
      {
        ...
        a: (
          <>
            <b>대시보드 → 📈 분석</b>에서 <b>총매출·주문수·평균 객단가</b>와 함께
            <b> 최근 14일 일별 매출 추이 그래프</b>, <b>인기 상품(실판매 수량)</b>, 카테고리·스킨 분포를 한눈에 봐요.
            <div className="mt-1.5 text-[12.5px] text-neutral-500 dark:text-neutral-400">주문이 쌓일수록 그래프가 채워져요. (베이직 요금제부터)</div>
          </>
        ),
      },
      {
