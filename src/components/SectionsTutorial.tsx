...
const STEPS = [
  {
    n: "",
    t: "빈 대문에서 시작",
    d: "아무것도 없는 대문에 블록을 하나씩 쌓아 올려요.",
    how: [
      "‘대문’은 손님이 우리 가게에 들어오면 가장 먼저 보는 첫 화면이에요.",
      "지금은 텅 비어 있어요. 걱정 마세요. 아래 단계만 천천히 따라 하면 돼요.",
      "‘블록’이란 글자나 사진을 담는 네모 칸이에요. 레고처럼 하나씩 쌓는 거예요.",
    ],
  },
  {
    n: "1",
    t: "🖼️ 기획전 배너",
    d: "큰 배너에 제목·이미지·버튼을 넣어 시선을 사로잡아요.",
    how: [
      "아래쪽 보라색 ‘＋ 블록 추가’ 단추를 손가락으로 누르세요.",
      "여러 종류가 나오면 그중 ‘🖼️ 기획전 배너’를 고르세요.",
      "‘제목’ 칸에 글자를 적으면 → 오른쪽 화면에 바로 똑같이 나타나요.",
      "사진을 넣고 싶으면 ‘파일 선택’을 눌러 갖고 있는 사진을 고르면 끝!",
    ],
  },
  {
    n: "2",
    t: "🛒 상품 선반",
    d: "베스트·신상품을 가로로 보기 좋게 진열해요.",
    how: [
      "다시 ‘＋ 블록 추가’를 누르고 ‘🛒 상품 선반’을 고르세요.",
      "‘진열 기준’에서 ‘베스트’나 ‘신상품’을 고르면, 그에 맞는 상품이 저절로 줄을 서요.",
      "내가 직접 고르고 싶으면 ‘직접 선택’을 누르고 상품을 톡톡 누르면 돼요.",
    ],
  },
  {
    n: "3",
    t: "✍️ 텍스트 블록",
    d: "브랜드 이야기나 안내 문구를 자유롭게 적어요.",
    how: [
      "‘＋ 블록 추가’ → ‘✍️ 텍스트 블록’을 고르세요.",
      "가게 자랑이나 하고 싶은 말을 칸에 적으면 그대로 화면에 나와요.",
      "예: ‘산지에서 매일 아침 직접 수확합니다’ 처럼요.",
    ],
  },
  {
    n: "4",
    t: "🔲 전체 상품 그리드",
    d: "모든 상품을 한눈에 펼쳐 보여줘요.",
    how: [
      "‘＋ 블록 추가’ → ‘🔲 전체 상품 그리드’를 고르세요.",
      "내 가게의 모든 상품이 바둑판처럼 가지런히 한 번에 펼쳐져요.",
      "손님이 상품을 쭉 둘러보기 좋아요.",
    ],
  },
  {
    n: "✓",
    t: "완성!",
    d: "이렇게 나만의 쇼핑몰 대문이 완성됩니다.",
    how: [
      "블록들의 ▲ ▼ 단추를 누르면 순서를 위아래로 바꿀 수 있어요.",
      "잘못 만들었으면 🗑(휴지통)을 눌러 지우면 돼요. 몇 번이든 다시 할 수 있어요.",
      "다 됐으면 위쪽 ‘쇼핑몰 보기’를 눌러 손님 눈에 어떻게 보이는지 확인하세요!",
    ],
  },
];
