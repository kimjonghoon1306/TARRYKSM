...
const THEMES = {
  produce: { cats:['전체','잎채소','뿌리채소','버섯','쌈·나물'], items:[
    { e:'🥬', n:'유기농 시금치 한 단', b:'들녘', p:3900, tag:'NEW', cat:'잎채소', r:4.8, rc:120, d:'오늘 아침 수확한 유기농 시금치.' },
    { e:'🥕', n:'흙당근 1kg', b:'들녘', p:5900, cat:'뿌리채소', r:4.7, rc:88, d:'단단하고 단맛 좋은 흙당근.' },
    { e:'🥦', n:'브로콜리 2송이', b:'그린팜', p:4500, tag:'BEST', cat:'잎채소', r:4.6, rc:64, d:'아삭한 제철 브로콜리.' },
    { e:'🧄', n:'햇마늘 500g', b:'육쪽', p:6900, cat:'뿌리채소', r:4.9, rc:150, d:'알이 굵은 햇마늘.' },
    { e:'🍄', n:'생표고버섯 한 팩', b:'숲밭', p:5500, cat:'버섯', r:4.7, rc:42, d:'향이 진한 생표고.' },
    { e:'🥗', n:'모둠 쌈채소', b:'초록', p:4200, tag:'HOT', cat:'쌈·나물', r:4.8, rc:97, d:'7종 신선 쌈채소 모둠.' },
  ]},
  seafood: { cats:['전체','활어·선어','조개·갑각','건어물','젓갈'], items:[
    { e:'🐟', n:'손질 갈치 2마리', b:'바다온', p:19000, tag:'오늘들어온', cat:'활어·선어', r:4.7, rc:74, d:'제주 은갈치, 손질해서 보내드려요.' },
    { e:'🦐', n:'생새우 500g', b:'바다온', p:16000, tag:'BEST', cat:'조개·갑각', r:4.8, rc:131, d:'탱글한 대하, 급속냉동.' },
    { e:'🦑', n:'손질 오징어 3마리', b:'동해상회', p:12000, cat:'활어·선어', r:4.6, rc:58, d:'내장 제거 손질 오징어.' },
    { e:'🦪', n:'생굴 1kg', b:'남해', p:14000, tag:'NEW', cat:'조개·갑각', r:4.7, rc:69, d:'통영 청정 해역 생굴.' },
    { e:'🍤', n:'마른새우 200g', b:'건이정', p:9000, cat:'건어물', r:4.9, rc:88, d:'국물용 마른새우.' },
    { e:'🧂', n:'명란젓 300g', b:'젓갈명가', p:13000, cat:'젓갈', r:4.8, rc:102, d:'짭조름 감칠맛 명란젓.' },
  ]},
  meat: { cats:['전체','한우','돼지','수입육','가공육'], items:[
    { e:'🥩', n:'한우 등심 200g', b:'한근정육', p:39000, tag:'프리미엄', cat:'한우', r:4.9, rc:210, d:'1++ 등급 한우 등심.' },
    { e:'🍖', n:'삼겹살 600g', b:'돈복', p:18000, tag:'BEST', cat:'돼지', r:4.7, rc:340, d:'두툼한 생삼겹.' },
    { e:'🥓', n:'베이컨 슬라이스', b:'델리육', p:8900, cat:'가공육', r:4.6, rc:120, d:'훈연 향 가득 베이컨.' },
    { e:'🍗', n:'닭다리살 1kg', b:'데일리', p:11000, tag:'NEW', cat:'돼지', r:4.5, rc:76, d:'순살 닭다리살.' },
    { e:'🌭', n:'수제 소시지 4입', b:'델리육', p:9900, cat:'가공육', r:4.7, rc:64, d:'첨가물 줄인 수제 소시지.' },
    { e:'🥩', n:'채끝 스테이크', b:'한근정육', p:29000, tag:'HOT', cat:'수입육', r:4.8, rc:95, d:'육즙 가득 채끝 스테이크.' },
  ]},
  bakery: { cats:['전체','식빵·바게트','페이스트리','케이크','쿠키'], items:[
    { e:'🍞', n:'우리밀 식빵', b:'오늘의빵', p:6500, tag:'NEW', cat:'식빵·바게트', r:4.9, rc:180, d:'매일 아침 구운 우리밀 식빵.' },
    { e:'🥐', n:'버터 크루아상', b:'오늘의빵', p:3800, tag:'BEST', cat:'페이스트리', r:4.8, rc:240, d:'프랑스 버터로 결을 살린 크루아상.' },
    { e:'🥖', n:'바게트', b:'밀과불', p:4500, cat:'식빵·바게트', r:4.7, rc:96, d:'겉바속촉 정통 바게트.' },
    { e:'🧁', n:'바닐라 컵케이크', b:'슈가룸', p:4200, tag:'HOT', cat:'케이크', r:4.6, rc:88, d:'폭신한 바닐라 컵케이크.' },
    { e:'🍪', n:'수제 쿠키 6입', b:'슈가룸', p:9000, cat:'쿠키', r:4.8, rc:130, d:'겉은 바삭 속은 쫀득.' },
    { e:'🥨', n:'프레첼', b:'밀과불', p:3500, cat:'페이스트리', r:4.5, rc:54, d:'짭짤한 수제 프레첼.' },
  ]},
  fruit: { cats:['전체','제철','수입과일','선물세트','말랭이'], items:[
    { e:'🍎', n:'부사 사과 5kg', b:'과수원집', p:28000, tag:'BEST', cat:'제철', r:4.8, rc:160, d:'당도 높은 햇사과.' },
    { e:'🍊', n:'제주 감귤 3kg', b:'귤마을', p:15000, tag:'NEW', cat:'제철', r:4.7, rc:210, d:'새콤달콤 노지 감귤.' },
    { e:'🍓', n:'설향 딸기 1팩', b:'베리팜', p:12000, tag:'HOT', cat:'제철', r:4.9, rc:280, d:'향 가득 설향 딸기.' },
    { e:'🍇', n:'샤인머스캣 1송이', b:'포도원', p:18000, cat:'제철', r:4.8, rc:140, d:'씨 없는 청포도.' },
    { e:'🥭', n:'애플망고 2입', b:'트로피칼', p:16000, cat:'수입과일', r:4.6, rc:72, d:'달콤한 애플망고.' },
    { e:'🍑', n:'복숭아 선물세트', b:'과수원집', p:35000, cat:'선물세트', r:4.7, rc:60, d:'말랑 달콤 복숭아 선물.' },
  ]},
  traditional: { cats:['전체','장류','김치·발효','전통주','차·한방'], items:[
    { e:'🍯', n:'재래식 막된장 1kg', b:'고운결', p:15000, tag:'인기', cat:'장류', r:4.9, rc:120, d:'장독에서 익힌 막된장.' },
    { e:'🌶️', n:'태양초 고추장 500g', b:'고운결', p:13000, tag:'BEST', cat:'장류', r:4.8, rc:96, d:'태양초로 담근 고추장.' },
    { e:'🥬', n:'포기김치 2kg', b:'손맛김치', p:22000, tag:'NEW', cat:'김치·발효', r:4.7, rc:150, d:'갓 담근 포기김치.' },
    { e:'🍶', n:'전통 막걸리', b:'주막', p:6000, cat:'전통주', r:4.6, rc:78, d:'생효모 살아있는 막걸리.' },
    { e:'🫖', n:'국산 쌍화차', b:'한방원', p:12000, cat:'차·한방', r:4.8, rc:64, d:'몸을 데우는 쌍화차.' },
    { e:'🧧', n:'명절 선물세트', b:'고운결', p:39000, cat:'장류', r:4.9, rc:42, d:'장·청 모둠 명절 선물.' },
  ]},
  banchan: { cats:['전체','밑반찬','국·찌개','김치','분식'], items:[
    { e:'🥢', n:'멸치볶음 200g', b:'정다운반찬', p:5000, tag:'BEST', cat:'밑반찬', r:4.8, rc:210, d:'바삭 고소한 멸치볶음.' },
    { e:'🍲', n:'된장찌개 2인분', b:'엄마손', p:7000, tag:'HOT', cat:'국·찌개', r:4.7, rc:130, d:'데우기만 하면 끝.' },
    { e:'🥬', n:'겉절이 500g', b:'정다운반찬', p:6000, tag:'NEW', cat:'김치', r:4.6, rc:88, d:'아삭한 겉절이.' },
    { e:'🍢', n:'어묵볶음', b:'엄마손', p:4500, cat:'밑반찬', r:4.7, rc:76, d:'달짝지근 어묵볶음.' },
    { e:'🍙', n:'주먹밥 세트', b:'분식방', p:5500, cat:'분식', r:4.5, rc:54, d:'한 끼 든든 주먹밥.' },
    { e:'🌶️', n:'장조림 300g', b:'정다운반찬', p:8000, cat:'밑반찬', r:4.8, rc:99, d:'짭짤 든든 소고기 장조림.' },
  ]},
  dairy: { cats:['전체','우유','치즈','요거트','아이스크림'], items:[
    { e:'🥛', n:'유기농 우유 1L', b:'목장하루', p:3200, tag:'NEW', cat:'우유', r:4.9, rc:240, d:'좋은 목장의 신선한 우유.' },
    { e:'🧀', n:'수제 모짜렐라', b:'치즈공방', p:9000, tag:'BEST', cat:'치즈', r:4.8, rc:120, d:'쫀득한 생모짜렐라.' },
    { e:'🍦', n:'우유 아이스크림', b:'목장하루', p:6500, tag:'HOT', cat:'아이스크림', r:4.7, rc:160, d:'진한 우유맛 아이스크림.' },
    { e:'🧈', n:'발효버터 200g', b:'목장하루', p:8500, cat:'치즈', r:4.6, rc:64, d:'고소한 발효버터.' },
    { e:'🥣', n:'플레인 요거트', b:'데일리밀크', p:4500, cat:'요거트', r:4.8, rc:130, d:'담백한 그릭 요거트.' },
    { e:'🍮', n:'우유 푸딩 2입', b:'목장하루', p:5000, cat:'아이스크림', r:4.7, rc:58, d:'부드러운 우유 푸딩.' },
  ]},
  gourmet: { cats:['ALL','선물세트','수입식품','와인·차','델리'], items:[
    { e:'🎁', n:'프리미엄 선물세트', b:'MAISON', p:89000, tag:'GIFT', cat:'선물세트', r:4.9, rc:88, d:'귀한 분께 드리는 모둠 선물.' },
    { e:'🍷', n:'내추럴 와인', b:'CAVE', p:42000, tag:'BEST', cat:'와인·차', r:4.8, rc:120, d:'엄선한 내추럴 와인.' },
    { e:'🧀', n:'수입 치즈 플래터', b:'DELI', p:28000, cat:'델리', r:4.7, rc:64, d:'3종 수입 치즈 모둠.' },
    { e:'🫒', n:'엑스트라버진 올리브유', b:'OLIO', p:24000, tag:'NEW', cat:'수입식품', r:4.8, rc:76, d:'콜드프레스 올리브유.' },
    { e:'🍫', n:'싱글오리진 초콜릿', b:'CACAO', p:15000, cat:'수입식품', r:4.9, rc:140, d:'카카오 70% 다크.' },
    { e:'🫖', n:'프리미엄 티 세트', b:'MAISON', p:32000, cat:'와인·차', r:4.7, rc:52, d:'잎차 6종 기프트.' },
  ]},
};
const SKIN_THEME = {
