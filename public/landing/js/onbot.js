...
(function () {
  var CATS = [
    ...
    { id: "features", label: "전체 기능", icon: "🛠", items: [
      ...
      { q: "🚚 배송비 설정 (무료배송·도서산간)", a: "몰 관리 <b>🚚 배송비</b>에서 기본 배송비와 <b>무료배송 기준액</b>을 정하면, 손님 결제창에서 배송비가 <b>자동 계산</b>되고 기준액을 넘으면 <b>무료배송</b>으로 바뀌어요. 도서산간 추가비도 받을 수 있어요." },
      { q: "🏷️ 할인가/정가 (정가 취소선·할인율)", a: "상품에 <b>정가(할인 전 가격)</b>를 넣으면 손님 화면에 <b>정가 취소선 · 빨간 할인율% · 판매가</b>가 함께 떠서 <b>세일 느낌</b>을 줄 수 있어요." },
      { q: "💬 상품 문의(Q&A) 받기", a: "손님이 상품에서 <b>문의</b>를 남기면(🔒비밀글 가능) <b>대시보드 → 💬문의</b>에 쌓이고, <b>답변 달기</b>로 답하면 손님 화면에 <b>판매자 답변</b>으로 붙어요." },
    ]},
    { id: "account", label: "계정·관리자", icon: "🔑", items: [
      { q: "비밀번호를 잊었어요", a: "로그인 화면의 <b>비밀번호 찾기</b>로 메일을 받아 새로 정하세요. 아이디는 <b>가입한 이메일</b>이에요." },
      { q: "관리자(컨트롤타워) 입장", a: "스튜디오 <b>좌측 상단 로고</b>를 <b>5번 빠르게 클릭</b>하면 관리자 로그인으로 들어가요. (숨은 입구라 평소엔 안 보여요)" },
    ]},
  ];
