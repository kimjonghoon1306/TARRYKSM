...
(function () {
  var CATS = [
    ...
    { id: "design", label: "디자인·꾸미기", icon: "🎨", items: [
      ...
      { q: "상단 로고·배너 꾸미기", a: "몰 관리의 <b>🎨 상단 꾸미기</b>에서 로고·배너 이미지와 제목·문구를 바꿀 수 있어요." },
      { q: "대문 구성(섹션) 편집", a: "<b>섹션 빌더</b>에서 기획전 배너·상품 선반(신상/베스트)·텍스트 블록을 <b>추가하고 순서를 바꿔</b> 나만의 대문을 짤 수 있어요." },
    ]},
